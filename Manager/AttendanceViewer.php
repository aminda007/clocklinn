...
<body class="">
 ...
 <div class="widget-item z-depth-1 ">
  ...
  <div class="top-border z-depth-1">
    ...
    <img src="" style="" >
    <p style="text-align:left; color:white; font-size: 40px ; vertical-align: auto;padding-left: 10px; margin:0;">Attendance </p>

    <p style="text-align:left; color:white; font-size: 28px;  vertical-align: auto; padding-left: 10px; margin:0;">Viewer</p>

  </div>
  <div>
    <div class="row">
        <form class="col s12" action="AttendanceViewHandler.php" method="post">
